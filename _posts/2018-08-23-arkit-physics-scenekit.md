---
layout: post
title: 「译」ARKit 教程：通过发射一个火箭来理解 Physics
...
提醒一下，这篇教程是建立在[**上一篇教程**](https://emptywalker.github.io/2018/08/arkit-horizontal-plane/)知识之上的。如果你有任何困惑，你可以随时查看 [**ARKit 系列教程**](https://www.appcoda.com/tag/arkit/)，以便可以在需要时帮助到你。


### Physics Body 解释
首先要做的事情就是解释 physics body 。这是基础知识之一，为了让 SceneKit 知道如何在 app 中模拟一个 SceneKit 节点。我们需要附带上一个 `SCNPhysicsBody` ， `SCNPhysicsBody` 是一个给节点添加物理仿真的对象。
